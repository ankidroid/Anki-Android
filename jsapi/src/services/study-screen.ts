...
export class StudyScreen extends Service {
    ...
    /**
     * Gets the next times a card should be shown after rating it.
     * The result's order is: Again, Hard, Good and Easy.
     */
    public getNextTimes(): Promise<Result<string[]>> {
        return this.request("get-next-times");
    }
