...
<jdk version="2">
      ...
      <roots>
        <annotationsPath>
          ...
          </root> <!-- Added closing tag for the first <root> -->
        </annotationsPath> <!-- Added closing tag for <annotationsPath> -->
      </roots> <!-- Added closing tag for <roots> -->
</jdk> <!-- Added closing tag for <jdk> -->
# External Annotations for Android Standard Library
