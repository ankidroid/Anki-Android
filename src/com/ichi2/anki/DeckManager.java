...
//     */
//  public static Decks getDeck(String deckpath, int requestingActivity) {
...
//     * @return the loaded deck
//     */
//  public static Decks getDeck(String deckpath, boolean setAsMainDeck, int requestingActivity) {
...
//     * @return the loaded deck
//     */
//  public static Decks getDeck(String deckpath, int requestingActivity, boolean rebuild) {
//      return getDeck(deckpath, false, true, requestingActivity, rebuild);
//  }
//  public synchronized static Decks getDeck(String deckpath, boolean setAsMainDeck, boolean doSafetyBackupIfNeeded, int requestingActivity, boolean rebuild) {
//      Decks deck = null;
//      lockDeck(deckpath);
//      try {
...
//                                  deck.closeDeck();
//                                  deck = Decks.openDeck(deckpath, rebuild, true);
//                              }
...
//                          }
//                          deckInformation.mDeck = Decks.openDeck(deckpath, true, requestingActivity == REQUESTING_ACTIVITY_SYNCCLIENT);
...
//                  }
//                  deck = Decks.openDeck(deckpath, rebuild, requestingActivity == REQUESTING_ACTIVITY_SYNCCLIENT);
...
//  public static Decks getMainDeck() {
...
//  public static Decks getMainDeck(int requestingActivity) {
...
//
//      DeckInformation(String key, Decks deck, int openedBy, boolean initiallyRebuilt) {
//          this.mKey = key;
//          this.mDeck = deck;
