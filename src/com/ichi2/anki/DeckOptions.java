            	...
            	try {
            		for (Entry<String, Object> entry : mUpdate.valueSet()) {
            			...
            			if (entry.getKey().equals("name")) {
                			...
                			mOptions.getJSONObject("rev").put("order", Integer.parseInt((String)entry.getValue()));
