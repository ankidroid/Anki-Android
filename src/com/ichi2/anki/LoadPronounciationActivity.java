...
/**
 * @author zaur Activity to load pronunciation files from Beolingus.
 * 
 *         User picks a source language and the source is passed as extra.
 * 
 *         When activity finished, it passes the filepath as another extra to
 *         the caller.
 * 
 */
public class LoadPronounciationActivity extends Activity implements OnCancelListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		audioView = AudioView.createPlayerInstance(this, R.drawable.av_play, R.drawable.av_pause, R.drawable.av_stop,
				null);
