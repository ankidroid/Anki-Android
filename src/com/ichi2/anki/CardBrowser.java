...
public class CardBrowser extends Activity
{
	...
	private final boolean mUndoRedoDialogShowing = false;
	...
	private static final String[] fSortTypes = new String[] { "", "noteFld", "noteCrt", "noteMod", "cardMod",
			"cardDue", "cardIvl", "cardEase", "cardReps", "cardLapses" };
		...
		public void onClick(DialogInterface dialog, int which)
		{
			switch (which)
			{
				...
				case CONTEXT_MENU_DETAILS:
					...
					Themes.htmlOkDialog(CardBrowser.this, getResources().getString(R.string.card_browser_card_details),
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mCardsAdapter = new SizeControlledListAdapter(this, mCards, R.layout.card_item, new String[] { "sfld", "deck",
				"flags" }, new int[] { R.id.card_sfld, R.id.card_deck, R.id.card_item }, sflRelativeFontSize,
				sflCustomFont);
		...
		mCardsListView.setOnItemClickListener(new OnItemClickListener()
		{
			...
			{
				// Intent editCard = new Intent(CardBrowser.this,
				// CardEditor.class);
				// editCard.putExtra(CardEditor.EXTRA_CALLER,
				// CardEditor.CALLER_CARDBROWSER_EDIT);
							...
							public void onClick(DialogInterface arg0, int which)
							{
								if (which != mOrder)
								{
									...
									try
									{
										...
										// default to descending for non-text
										// fields
										if (fSortTypes[mOrder].equals("noteFld"))
										{
											mOrderAsc = true;
	...
	// private DeckTask.TaskListener mLoadCardsHandler = new
	// DeckTask.TaskListener() {
	...
	// getResources().getString(R.string.card_browser_load), true, true, new
	// OnCancelListener() {
	//
	// @Override
	// public void onCancel(DialogInterface arg0) {
	...
	// StyledDialog.Builder(CardBrowser.this);
	...
	//
	// int field =
	// AnkiDroidApp.getSharedPrefs(getBaseContext()).getInt("cardBrowserField",
	// 0);
	//
	...
	// "CardBrowser: mLoadCardsHandler: OutOfMemoryError: " + e);
	...
	private final DeckTask.TaskListener mDeleteNoteHandler = new DeckTask.TaskListener()
	{
		@Override
		public void onPreExecute()
		{
	...
	private final DeckTask.TaskListener mSearchCardsHandler = new DeckTask.TaskListener()
	{
		@Override
	...
	private final DeckTask.TaskListener mReloadCardsHandler = new DeckTask.TaskListener()
	{
		@Override
		public void onProgressUpdate(TaskData... values)
		{
	...
	private final DeckTask.TaskListener mSortCardsHandler = new DeckTask.TaskListener()
	{
		@Override
		public void onPreExecute()
		{
	...
	// private DeckTask.TaskListener mUndoRedoHandler = new
	// DeckTask.TaskListener() {
	// @Override
	// public void onPreExecute() {
	// Resources res = getResources();
