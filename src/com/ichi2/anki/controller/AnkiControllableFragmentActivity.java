...
public abstract class AnkiControllableFragmentActivity extends FragmentActivity implements IAnkiControllable {
    @Override
    protected void onResume() {
    	super.onResume();
    	AnkiDroidApp.getControllerManager().setReceiverActivity(AnkiControllableFragmentActivity.this);
    }
