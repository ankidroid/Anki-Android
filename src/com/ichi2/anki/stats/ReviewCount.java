...
public class ReviewCount {
    ...
    public ReviewCount(ImageView imageView, Collection collectionData, boolean isWholeCollection){
    ...
    private void calcStats(int type, boolean reps){
        mType = type;
        Stats stats = new Stats(mCollectionData, mIsWholeCollection);
        stats.calculateDone(type, reps);
