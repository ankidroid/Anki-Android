...
public class DownloadManagerService extends Service {
	...
	public void onCreate() {
		...
		// TODO: Get user, password and destination from preferences
	...
	/**
	 * The IDownloadManagerService is defined through IDL
	 */
			...
			if(fileList != null)
			{
				for(int i = 0; i < fileList.length; i++)
				{
					...
					else if(filename.endsWith(".anki.updating"))
					{
						...
						mSharedDeckDownloads.add(new SharedDeckDownload(title));
					}
				}
				notifyObservers();
			}
	...
	private void showNotification(String deckTitle) 
	{
		...
		notification.setLatestEventInfo(this, deckTitle, "Deck downloaded", contentIntent);
	...
	private String unzipSharedDeckFile(String zipFilename, String title) throws IOException
	{
	...
	{ 
		//Log.i(TAG, "onProgressUpadte");
        // Broadcast to all clients the new value.
		//Download download = new Download("Download test + " + counter);
		//mPersonalDeckDownloads.add(download);
		SharedDeckDownload sharedDeckDownload = new SharedDeckDownload(1, "SharedDeckDownload test " + counter, 0);
