...
/**
 * Instances of these threads are launched by a {@link VeecheckService} to do the work of retrieving and processing a
 * versions document to extract intent information. The thread reports its completion back to the
 * {@link VeecheckService} that started it.
 * 
 * @author Tom Gibara
 */
...
public class VeecheckThread extends Thread {
    ...
    private VeecheckResult performRequest(VeecheckVersion version, String uri) throws ClientProtocolException,
