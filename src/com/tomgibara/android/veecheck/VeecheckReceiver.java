...
/**
 * An abstract base class for creating a {@link BroadcastReceiver} that will respond to requests to consider or
 * reschedule checks for new application versions. This class should be extended with an implementation of the
...
public abstract class VeecheckReceiver extends BroadcastReceiver {
    ...
    /**
     * Supplies the settings that govern the operation of this {@link BroadcastReceiver} within the given context.
     * 
     * @param context the context within which this {@link BroadcastReceiver} is operating
    ...
    /**
     * Supplies an object that can persist the state information needed by the veecheck within the given context.
     * 
     * @param context the context within which this {@link BroadcastReceiver} is operating
     ...
     * {@link BroadcastReceiver} to consider checking for updates.
     * 
    ...
    /**
     * Makes the periodic scheduling of {@link #ACTION_CONSIDER_CHECK} {@link Intent}s constent with the settings
     * supplied by {@link #createSettings(Context)}.
     * 
     * @param context the context in which the {@link BroadcastReceiver} is operating
     */
    ...
    /**
     * Consults the settings to determine whether a {@link Service} should be started to perform a check for application
     * updates.
     * 
     * @param context the context in which the {@link BroadcastReceiver} is operating
     */
