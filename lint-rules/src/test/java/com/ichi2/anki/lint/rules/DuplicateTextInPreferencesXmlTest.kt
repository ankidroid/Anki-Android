...
"""
    ...
    fun showsErrorForInvalidFile() {
        lint()
            ...
            .expectErrorCount(2)
            .expect(
                """res/xml/invalidpreference.xml:2: Error: Do not use the same string for the title and summary of a preference [DuplicateTextInPreferencesXml]
        <PreferenceScreen xmlns:android="http://schemas.android.com/apk/res/android"
        ^
res/xml/invalidpreference.xml:7: Error: Do not use the same string for the title and summary of a preference [DuplicateTextInPreferencesXml]
                <EditTextPreference                                                    
                ^
2 errors, 0 warnings
                """.trimIndent()
