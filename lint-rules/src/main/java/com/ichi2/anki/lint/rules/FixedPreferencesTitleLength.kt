...
class FixedPreferencesTitleLength : ResourceXmlDetector(), XmlScanner {
    ...
    private val valuesData: MutableMap<String, Pair<Element, Location.Handle>> = HashMap<String, Pair<Element, Location.Handle>>()
    ...
    override fun afterCheckEachProject(context: Context) {
        for (title in xmlData) {
            ...
            val stringData: Pair<Element, Location.Handle> = valuesData[title]!!
    ...
    companion object {
        ...
        private val implementation = Implementation(FixedPreferencesTitleLength::class.java, RESOURCE_FILE_SCOPE)
        @JvmField
