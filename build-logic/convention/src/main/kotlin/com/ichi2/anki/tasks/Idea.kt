...
fun Project.idea() {
    project.plugins.withType(org.gradle.plugins.ide.idea.IdeaPlugin::class.java) {
        project.extensions.configure(org.gradle.plugins.ide.idea.model.IdeaModel::class.java) {
            module {
