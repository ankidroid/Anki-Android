...
public class TemporaryModel {
    ...
    public void saveToDatabase(CollectionTask.TaskListener listener) {
        ...
        Model model = mEditedModel;
        ArrayList<Object[]> templateChanges = getAdjustedTemplateChanges();
        Task saveModel = new Task() {
            /**
        ...
        CollectionTask.launchCollectionTask(saveModel, listener);
