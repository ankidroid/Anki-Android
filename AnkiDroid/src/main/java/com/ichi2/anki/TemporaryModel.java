...
public class TemporaryModel {
    ...
    public void saveToDatabase(CardTemplateEditor.CardTemplateFragment.SaveModelAndExitHandler listener) {
        ...
        final Model model = mEditedModel;
        final @NonNull ArrayList<Object[]> adjustedTemplateChanges = getAdjustedTemplateChanges();
        TaskManager.launchCollectionTask((@NonNull Collection col, @NonNull ProgressSenderAndCancelListener<Void> collectionTask) -> {
            ...
            try {
                for (Object[] change : adjustedTemplateChanges) {
