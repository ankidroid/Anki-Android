...
class NotificationDatastore private constructor(val context: Context) {
    ...
    */
    ...
    /**
     * Clears all the existing data present in [NotificationDatastore]. Intended to use in Unit Testing.
     * **NOTE: Only use this function when it is extremely required to delete add notification preference data.**
     * */
