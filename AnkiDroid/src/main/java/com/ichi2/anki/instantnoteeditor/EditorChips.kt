...
private fun AnkiActivity.displayUpdateClozeNumberDialog(
    ...
    val repositionDialog =
        IntegerDialog().apply {
            setArgs(
                title = this@displayUpdateClozeNumberDialog.getString(CommonString.change_cloze_number),
                prompt = this@displayUpdateClozeNumberDialog.getString(CommonString.cloze_number),
                digits = 2,
