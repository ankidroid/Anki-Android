...
open class AnkiFragment(@LayoutRes layout: Int) : Fragment(layout), AnkiActivityProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        requireActivity().window.statusBarColor = Themes.getColorFromAttr(requireContext(), intArrayOf(R.attr.appBarColor))[0]
    ...
    fun setNavigationBarColor(@AttrRes attr: Int) {
        requireActivity().window.navigationBarColor =
            Themes.getColorFromAttr(requireContext(), intArrayOf(attr))[0]
    }
