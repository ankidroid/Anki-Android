...
public class CardBrowser extends NavigationDrawerActivity implements
    ...
    protected void onStop() {
        ...
        CollectionTask.cancelTask(TASK_TYPE_SEARCH_CARDS);
        CollectionTask.cancelTask(TASK_TYPE_RENDER_BROWSER_QA);
        super.onStop();
        if (!isFinishing()) {
    ...
    private void updateMultiselectMenu() {
        ...
        if (!mCheckedCardPositions.isEmpty()) {
            CollectionTask.launchCollectionTask(TASK_TYPE_CHECK_CARD_SELECTION,
    ...
    private void flagTask (int flag) {
        CollectionTask.launchCollectionTask(TASK_TYPE_DISMISS_MULTI,
                                mFlagCardHandler,
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_undo:
                if (getCol().undoAvailable()) {
                    CollectionTask.launchCollectionTask(TASK_TYPE_UNDO, mUndoHandler);
                }
                return true;
            ...
            case R.id.action_reset_cards_progress: {
                ...
                Runnable confirm = () -> {
                    ...
                    CollectionTask.launchCollectionTask(TASK_TYPE_DISMISS_MULTI, mResetProgressCardHandler,
            ...
            case R.id.action_reposition_cards: {
                ...
                repositionDialog.setCallbackRunnable(days ->
                    CollectionTask.launchCollectionTask(TASK_TYPE_DISMISS_MULTI, mRepositionCardHandler,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == EDIT_CARD && resultCode != RESULT_CANCELED) {
            ...
            CollectionTask.launchCollectionTask(TASK_TYPE_UPDATE_NOTE, mUpdateCardHandler,
    ...
    private void searchCards() {
        ...
        if (colIsOpen() && mCardsAdapter!= null) {
            ...
            CollectionTask.launchCollectionTask(TASK_TYPE_SEARCH_CARDS, mSearchCardsHandler, new CollectionTask.TaskData(
            ...
            if ((size > 0) && (firstVisibleItem < size) && ((lastVisibleItem - 1) < size)) {
                ...
                if (firstAns == null || lastAns == null) {
                    ...
                    if ((currentTime - mLastRenderStart > 300 || lastVisibleItem >= totalItemCount)) {
                        ...
                        CollectionTask.cancelTask(TASK_TYPE_RENDER_BROWSER_QA);
                        CollectionTask.launchCollectionTask(TASK_TYPE_RENDER_BROWSER_QA, mRenderQAHandler,
    ...
    void executeChangeCollectionTask(long[] ids, long newDid) {
        ...
        CollectionTask.launchCollectionTask(TASK_TYPE_DISMISS_MULTI, mChangeDeckHandler,
