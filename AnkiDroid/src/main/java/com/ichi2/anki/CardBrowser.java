    ...
    * When the list is changed, the position member of its elements should get changed.*/
    ...
    private static class DeleteNoteHandler extends ListenerWithProgressBarCloseOnFalse {
        ...
        protected void actualOnValidPostExecute(CardBrowser browser, TaskData result) {
            ...
            browser.invalidateOptionsMenu();    // maybe the availability of undo changed
            // snackbar to offer undo
            browser.mUndoSnackbar = UIUtils.showSnackbar(browser, browser.getString(R.string.deleted_message), SNACKBAR_DURATION, R.string.undo, v -> TaskManager.launchCollectionTask(UNDO, browser.mUndoHandler), browser.mCardsListView, null);
            browser.searchCards();
        }
    }
