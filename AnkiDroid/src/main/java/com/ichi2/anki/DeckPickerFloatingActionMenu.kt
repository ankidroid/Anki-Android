...
class DeckPickerFloatingActionMenu(
    ...
    private fun showFloatingActionMenu() {
        ...
        if (deckPicker.allDeckpickerSnackbar != null && deckPicker.allDeckpickerSnackbar!!.isShown)deckPicker.allDeckpickerSnackbar!!.dismiss()
        ...
        val addDeckListener = View.OnClickListener {
            if (isFABOpen) {
                ...
                createDeckDialog.showDialog().positiveButton {
                    createDeckSnackBar = createDeckDialog.snackbar
                }
            }
        }
