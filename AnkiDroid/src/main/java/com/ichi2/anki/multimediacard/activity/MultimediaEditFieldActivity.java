...
public class MultimediaEditFieldActivity extends AnkiActivity
        ...
        if (mField.getType() == EFieldType.IMAGE) {
            ...
            if (!bChangeToText) {
                ...
                if (length > sImageLimit) {
                    ...
                    Uri uri = FileProvider.getUriForFile(this, getPackageName() + ".apkgfileprovider", f);
                    showCropDialog(size, uri);
                    return;
                }
            }
    ...
    public void showCropDialog(String size, Uri uri) {
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive((dialog, which) -> imageFieldController.photoCrop(uri))
