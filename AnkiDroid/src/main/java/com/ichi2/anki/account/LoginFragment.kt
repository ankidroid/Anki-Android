...
import com.ichi2.anki.account.AccountActivity.Companion.STAR_FROM_DECKPICKER
...
class LoginFragment : Fragment(R.layout.my_account) {
    ...
    private fun initListeners() {
        ...
        requireView()
            ...
            .setOnClickListener { openUrl(Uri.parse(resources.getString(R.string.resetpw_url))) }
    ...
    private fun initObservers() {
        viewModel.loginButtonEnabled.observe(viewLifecycleOwner) { isEnabled ->
            ...
            viewModel.loginState.collect { state ->
                when (state) {
                    is LoginState.Success -> {
                        ...
                        val isForResult = arguments?.getBoolean(STAR_FROM_DECKPICKER) ?: false
