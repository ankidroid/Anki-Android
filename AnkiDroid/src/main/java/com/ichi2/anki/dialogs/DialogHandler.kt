...
class DialogHandler(activity: AnkiActivity) : Handler(getDefaultLooper()) {
    ...
    override fun handleMessage(msg: Message) {
        ...
        if (msg.what == MSG_SHOW_COLLECTION_LOADING_ERROR_DIALOG) {
            ...
            (mActivity.get() as DeckPicker?)!!.showImportDialog(ImportDialog.DIALOG_IMPORT_REPLACE_CONFIRM, msgData.getStringArrayList("importPath") as java.util.ArrayList<String>)
        } else if (msg.what == MSG_SHOW_COLLECTION_IMPORT_ADD_DIALOG) {
            // Handle import of deck package APKG
            (mActivity.get() as DeckPicker?)!!.showImportDialog(ImportDialog.DIALOG_IMPORT_ADD_CONFIRM, msgData.getStringArrayList("importPath") as java.util.ArrayList<String>)
