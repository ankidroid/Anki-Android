...
class DeckPickerNoSpaceLeftDialog : AnalyticsDialogFragment() {
    override fun onCreateDialog(savedInstanceState: Bundle?): MaterialDialog {
        ...
        return MaterialDialog.Builder(requireActivity())
            ...
            .onPositive { dialog: MaterialDialog?, which: DialogAction? -> (activity as DeckPicker?)?.startLoadingCollection() }
            .cancelListener { dialog: DialogInterface? -> (activity as DeckPicker?)?.startLoadingCollection() }
            .show()
    }
