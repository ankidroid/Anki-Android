...
class NoteTypeFieldEditorContextMenu : AnalyticsDialogFragment() {
    ...
    enum class NoteTypeFieldEditorContextMenuAction(
        ...
        Reposition(0, CommonString.model_field_editor_reposition_menu),
        Sort(1, CommonString.model_field_editor_sort_field),
        Rename(2, CommonString.model_field_editor_rename),
        Delete(3, CommonString.model_field_editor_delete),
        AddLanguageHint(4, CommonString.model_field_editor_language_hint),
    }
