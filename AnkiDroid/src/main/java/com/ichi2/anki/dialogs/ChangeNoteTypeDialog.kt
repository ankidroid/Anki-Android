 ...
 */
// TODO: The dialog may want to show the 'input' note type
// TODO: The dialog may want to show the note count
class ChangeNoteTypeDialog : AnalyticsDialogFragment() {
            ...
            .create {
                ...
                launchCatchingTask {
                    ...
                    viewModel.initStatus.collect {
                        ...
                        when (it) {
                            InitStatus.PENDING, InitStatus.IN_PROGRESS -> {
    ...
    private fun setupChangeNoteTypeDialog() {
        ...
        requireDialog().findViewById<Spinner>(R.id.cnt_note_type_spinner)!!.apply {
            ...
            val position = viewModel.availableNoteTypes.indexOfFirst { it.id == viewModel.inputNoteType.id }
    ...
    companion object {
        ...
        fun newInstance(noteIds: List<NoteId>) =
            ChangeNoteTypeDialog().apply {
                arguments =
                    bundleOf(
                        ARG_NOTE_IDS to noteIds.distinct().toLongArray(),
                    )
        ...
        private fun showDiscardedTemplatesMessage(discardedTemplateNames: List<String>) {
            ...
            templateRemovalLabel.text =
                SpannableStringBuilder()
                    ...
                    // TODO: Separator is not i18ned (2 cases in this class)
...
private fun AnkiActivity.changeNoteType(viewModel: ChangeNoteTypeViewModel) =
    this.launchCatchingRequiringOneWaySync {
        // TODO: This does not handle 'expected' errors well: "java.lang.IllegalArgumentException"
        // TODO: Maybe expose "no changes" so we can disable the positive button and avoid an exception
        val notesUpdated =
            withProgress {
