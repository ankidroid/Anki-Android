...
class DatabaseErrorDialog : AsyncDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): MaterialDialog {
        ...
        return when (type) {
            ...
            DIALOG_FULL_DISK -> {
                ...
                // Database Check failed to execute successfully; give
                dialog.show {
                    contentNullable(message)
                    positiveButton(R.string.dialog_ok) {
                        (activity as DeckPicker).integrityCheck()
    ...
    private val message: String?
        get() = when (requireArguments().getInt("dialogType")) {
            ...
            DIALOG_FULL_DISK -> resources.getString(R.string.storage_full_message)
    ...
    private val title: String
        get() = when (requireArguments().getInt("dialogType")) {
            ...
            DIALOG_FULL_DISK -> resources.getString(R.string.storage_full_title)
