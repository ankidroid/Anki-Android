...
class NoteEditor :
    ...
    fun hasUnsavedChanges(): Boolean {
        ...
        // changed note type?
        if (!addNote && currentEditedCard != null) {
            val newNoteType: JSONObject? = currentlySelectedNotetype
            val oldNoteType: JSONObject = currentEditedCard!!.noteType(getColUnsafe)
    ...
    private fun updateCards(noteType: JSONObject?) {
    ...
    private fun allowFieldRemapping(): Boolean {
        // Map<String, Pair<Integer, JSONObject>> fMapNew = getCol().getNoteTypes().fieldMap(getCurrentlySelectedModel())
