...
open class DeckPicker :
    ...
    private fun shouldOfferToMigrate(): Boolean {
        ...
        if (!AnkiBuildConfig.ALLOW_UNSAFE_MIGRATION && !isLoggedIn()) {
            return false
        }
    ...
    private fun showStartupScreensAndDialogs(preferences: SharedPreferences, skip: Int) {
        ...
        if (!BackupManager.enoughDiscSpace(CollectionHelper.getCurrentAnkiDroidDirectory(this))) {
            ...
            if (VersionUtils.isReleaseVersion) {
                ...
                val infoIntentStart = Intent(this, Info::class.java)
                infoIntentStart.putExtra(Info.TYPE_EXTRA, Info.TYPE_NEW_VERSION)
                showNewVersionInfoLauncher.launch(infoIntentStart)
            } else {
    ...
    private fun performMediaSyncBeforeStorageMigration() {
        ...
        val showUnsafeSyncDialog = (AnkiBuildConfig.ALLOW_UNSAFE_MIGRATION && !isLoggedIn())
