...
open class DeckPicker :
    ...
    private suspend fun handleDeckSelection(
        ...
        if (!deck.filtered && viewModel.isDeckAndSubdeckEmpty(did)) {
     ...
     */
    private fun DeckPicker.getNodeByDid(did: DeckId): DeckNode =
        deckListAdapter.currentList[viewModel.findDeckPosition(did, deckListAdapter.currentList)].deckNode
    ...
    fun renameDeckDialog(did: DeckId) {
        launchCatchingTask {
            val currentName = viewModel.getDeckName(did)
