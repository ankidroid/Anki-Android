...
/**
 * Schema migration settings for [ReviewReminder], used in [ReviewRemindersDatabase].
 * Separated out into its own object for better organization, and so it can be easily mocked in tests.
 *
 * Also feel free to store old [ReviewReminderSchema]s here.
 * See examples for how to do this at [TestingReviewReminderMigrationSettings].
 */
object ReviewReminderMigrationSettings {
    /**
     ...
     * @see [ReviewReminder]
     */
    val SCHEMA_VERSION = ReviewReminderSchemaVersion(1)
     ...
     * @see [ReviewReminder]
     */
    val oldReviewReminderSchemasForMigration: Map<ReviewReminderSchemaVersion, KClass<out ReviewReminderSchema>> =
        mapOf(
...
object TestingReviewReminderMigrationSettings {
     ...
     */
    val SCHEMA_VERSION = ReviewReminderSchemaVersion(3)

    /**
     * Testing old review reminder schemas for migration.
     * @see [ReviewReminderMigrationSettings.oldReviewReminderSchemasForMigration]
     */
    val oldReviewReminderSchemasForMigration: Map<ReviewReminderSchemaVersion, KClass<out ReviewReminderSchema>> =
        mapOf(
            ReviewReminderSchemaVersion(1) to ReviewReminderSchemaVersionOne::class,
            ReviewReminderSchemaVersion(2) to ReviewReminderSchemaVersionTwo::class,
 ...
 * edited to return instances of the newly-created [ReviewReminderSchema]. Then, increment [ReviewRemindersDatabase.SCHEMA_VERSION].
 *
