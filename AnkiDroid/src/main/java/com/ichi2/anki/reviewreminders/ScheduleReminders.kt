...
class ScheduleReminders : Fragment(R.layout.fragment_schedule_reminders) {
    private lateinit var mSchedulerScope: SchedulerScope

    /**
     * SchedulerScope: The possible modes the ScheduleReminders fragment can be triggered in
     */
    ...
    override fun onViewCreated(
        ...
        mSchedulerScope = requireArguments().getSerializableCompat<SchedulerScope>(EXTRAS_SCOPE_KEY) as SchedulerScope

        val toolbar =
            view.findViewById<MaterialToolbar>(R.id.toolbar).apply {
                setTitle(
                    when (mSchedulerScope) {
        ...
        if (mSchedulerScope == SchedulerScope.SINGLE_DECK_SPECIFIC) {
