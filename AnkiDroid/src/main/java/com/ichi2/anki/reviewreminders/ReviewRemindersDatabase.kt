        ...
        try {
            ...
            when (e) {
                ...
                -> {
                    ...
                    Timber.e(e, "${reminderLogPrefix()} $errorString")
            ...
            editRemindersForScope(scope) { reminders: ReviewReminderGroup ->
                reminders.apply {
                    ...
                    if (storedReminder == null) {
                        ...
                        Timber.e(
                            "${reminderLogPrefix(id)} Returning null for retrieveRefreshedReminder for reminder ${id.value} " +
                    ...
                    if (storedReminder.latestNotifDelivered()) {
                        ...
                        Timber.i(
                            "${reminderLogPrefix(id)} skip: Returning null for retrieveRefreshedReminder " +
                                "for reminder %d: Latest already delivered at %d (%dms ago)",
                            id.value,
