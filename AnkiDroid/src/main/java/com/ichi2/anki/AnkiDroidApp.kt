...
open class AnkiDroidApp :
    ...
    // Start with verified devices from KOReader
    ...
    private fun initializeSafeDisplayMode() {
        ...
        if (!isSafeDisplaySet && hasEInkDisplay()) {
            ...
            Timber
                .tag("SafeDisplayMode")
                .d("No changes made. Either safeDisplay is already set or no confirmed E-Ink display detected.")
        }
    }
    ...
    fun hasEInkDisplay(): Boolean {
        ...
        Timber.tag("SafeDisplayMode").d("Checking device: $currentDevice")
        ...
        if (exactMatch) {
            ...
            Timber.tag("SafeDisplayMode").d("Confirmed E-ink device: $currentDevice")
            return true
        }
        ...
        if (partialMatch) {
            ...
            Timber.tag("SafeDisplayMode").w("Potential E-ink device: $currentDevice")
        } else {
            Timber.tag("SafeDisplayMode").d("Not an E-ink device: $currentDevice")
        }
        return false
    }
