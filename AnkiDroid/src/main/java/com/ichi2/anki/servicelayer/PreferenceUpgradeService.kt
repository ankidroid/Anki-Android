...
object PreferenceUpgradeService {
    ...
    abstract class PreferenceUpgrade private constructor(val versionIdentifier: VersionIdentifier) {
        ...
        companion object {
            ...
            internal fun getPreferenceVersion(preferences: SharedPreferences) = preferences.getInt(upgradeVersionPrefKey, 0)
        ...
        internal class RemoveReviewerETA : PreferenceUpgrade(15) {
            override fun upgrade(preferences: SharedPreferences) = preferences.edit { remove("showETA") }
        }
    }
}
