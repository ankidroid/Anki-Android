...
abstract class PermissionsFragment(
    ...
    override fun onResume() {
        ...
        setFragmentResult(PERMISSIONS_FRAGMENT_RESULT_KEY, bundleOf(HAS_ALL_PERMISSION_KEY to hasAllPermissions()))
    }
    ...
    companion object {
        ...
        const val HAS_ALL_PERMISSION_KEY = "HAS_ALL_PERMISSION"
    }
}
