    ...
    companion object {
        fun newInstance(introductionResources: IntroductionActivity.IntroductionResources): IntroductionFragment {
            ...
            val resourcesBundle = bundleOf(
                "Title" to introductionResources.mTitle,
                "Description" to introductionResources.mDescription,
                "Image" to introductionResources.mImage,
                "WebPage" to introductionResources.mWebPage,
                "Localization" to introductionResources.mLocalization
            )
