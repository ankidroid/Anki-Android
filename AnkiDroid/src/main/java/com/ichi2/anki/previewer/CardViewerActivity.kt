 ...
 */
class CardViewerActivity : SingleFragmentActivity(), SyncErrorDialog.SyncErrorDialogListenerProvider {
     ...
     */
    override fun requireSyncErrorDialogListener() = (fragment as SyncErrorDialog.SyncErrorDialogListenerProvider).requireSyncErrorDialogListener()
