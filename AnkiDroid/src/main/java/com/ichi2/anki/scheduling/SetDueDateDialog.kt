...
// TODO: This does not handle configuration changes on some EditTexts [screen rotate]
class SetDueDateDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return AlertDialog.Builder(requireContext()).create {
            ...
            // setup checkbox
            findViewById<MaterialCheckBox>(R.id.change_interval)!!.setOnCheckedChangeListener { _, isChecked ->
