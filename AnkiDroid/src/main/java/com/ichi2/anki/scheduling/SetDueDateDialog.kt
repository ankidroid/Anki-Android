...
class SetDueDateDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            .create {
                ...
                TabLayoutMediator(binding.tabLayout, binding.setDueDatePager) { tab: TabLayout.Tab, position: Int ->
    ...
    class SelectSingleDateFragment : Fragment() {
        ...
        private var fragmentBinding: SetDueDateSingleBinding? = null
        private val binding: SetDueDateSingleBinding
            get() = fragmentBinding!!
     ...
     */
    class SelectDateRangeFragment : Fragment() {
        private val viewModel: SetDueDateViewModel by activityViewModels<SetDueDateViewModel>()

        // binding pattern to handle onCreateView/onDestroyView
        private var fragmentBinding: SetDueDateRangeBinding? = null
        private val binding: SetDueDateRangeBinding
            get() = fragmentBinding!!
