 ...
 * go to step 3.
 *
 * 2. If MyActivity does not already exist, then create it by extending OnboardingImpl and
 * then create a new enum class implementing OnboardingFlag.
 *
 * 2. Create a new method to display the tutorial.
 *
...
class Onboarding {
     ...
     */
    abstract class OnboardingImpl<Feature, ActivityType>(
    ...
    ) : OnboardingImpl<DeckPicker.DeckPickerOnboardingEnum, com.ichi2.anki.DeckPicker>(mActivityContext, mutableListOf()) {
    ...
    class NoteEditor(private val mActivityContext: com.ichi2.anki.NoteEditor) :
        OnboardingImpl<NoteEditor.NoteEditorOnboardingEnum, com.ichi2.anki.NoteEditor>(mActivityContext, mutableListOf()) {
    ...
    class CardBrowser(private val mActivityContext: com.ichi2.anki.CardBrowser) :
        OnboardingImpl<CardBrowser.CardBrowserOnboardingEnum, com.ichi2.anki.CardBrowser>(mActivityContext, mutableListOf()) {
