...
class AboutFragment : Fragment() {
    ...
    private fun copyDebugInfo() {
        ...
        if (clipboardManager != null) {
            ...
            showSnackbar(getString(R.string.about_ankidroid_successfully_copied_debug), Snackbar.LENGTH_LONG)
//            UIUtils.showThemedToast(context, getString(R.string.about_ankidroid_successfully_copied_debug), true)
        } else {
            showSnackbar(getString(R.string.about_ankidroid_error_copy_debug_info), Snackbar.LENGTH_LONG)
