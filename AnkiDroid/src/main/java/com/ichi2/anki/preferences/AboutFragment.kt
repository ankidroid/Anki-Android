...
class AboutFragment : Fragment() {
    ...
    private fun copyDebugInfo() {
        ...
        if (clipboardManager != null) {
            ...
            showSnackbar(R.string.about_ankidroid_successfully_copied_debug, Snackbar.LENGTH_SHORT)
        } else {
            showSnackbar(R.string.about_ankidroid_error_copy_debug_info, Snackbar.LENGTH_LONG)
        }
    }
