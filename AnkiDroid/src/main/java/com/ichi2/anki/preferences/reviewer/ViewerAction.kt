    ...
    fun title(context: Context): String =
        with(context) {
            when (this@ViewerAction) {
                ...
                UNDO -> getString(CommonString.undo)
                REDO -> getString(CommonString.redo)
                FLAG_MENU -> TR.browsingFlag()
                MARK -> TR.sentenceCase.markNote
                EDIT -> getString(CommonString.cardeditor_title_edit_card)
                BURY_MENU -> TR.studyingBury()
                SUSPEND_MENU -> TR.studyingSuspend()
                DELETE -> TR.sentenceCase.deleteNote
                TOGGLE_WHITEBOARD -> getString(CommonString.gesture_toggle_whiteboard)
                DECK_OPTIONS -> TR.sentenceCase.deckOptions
                CARD_INFO -> TR.sentenceCase.cardInfo
                ADD_NOTE -> getString(CommonString.menu_add_note)
                TAG -> getString(CommonString.menu_edit_tags)
                RESET_PROGRESS -> getString(CommonString.card_editor_reset_card)
                TOGGLE_AUTO_ADVANCE -> getString(CommonString.toggle_auto_advance)
                RECORD_VOICE -> getString(CommonString.record_voice)
                PLAY_MEDIA -> getString(CommonString.replay_media)
                USER_ACTION_1 -> getString(CommonString.user_action_1)
                USER_ACTION_2 -> getString(CommonString.user_action_2)
                USER_ACTION_3 -> getString(CommonString.user_action_3)
                USER_ACTION_4 -> getString(CommonString.user_action_4)
                USER_ACTION_5 -> getString(CommonString.user_action_5)
                USER_ACTION_6 -> getString(CommonString.user_action_6)
                USER_ACTION_7 -> getString(CommonString.user_action_7)
                USER_ACTION_8 -> getString(CommonString.user_action_8)
                USER_ACTION_9 -> getString(CommonString.user_action_9)
                ...
                PAGE_DOWN,
                EXIT,
                -> getString(CommonString.empty_string)
            }
        }
