...
enum class ViewerAction(
    ...
    TOGGLE_AUTO_ADVANCE(R.id.action_toggle_auto_advance, R.drawable.ic_fast_forward_outlined, R.string.toggle_auto_advance, DISABLED),
    RECORD_VOICE(R.id.action_record_voice, R.drawable.ic_mic_outlined, R.string.record_voice, DISABLED),
