...
public class Lookup {
    ...
    public static boolean lookUp(String text) {
        ...
        switch (mDictionary) {
            case DICTIONARY_NONE:
                UsageAnalytics.sendAnalyticsEvent(Lookup.class.getSimpleName(), "none");
                return false;
            case DICTIONARY_AEDICT:
                ...
                UsageAnalytics.sendAnalyticsEvent(Lookup.class.getSimpleName(), "aedict");
                return true;
            case DICTIONARY_LEO_WEB:
            case DICTIONARY_LEO_APP:
                mLookupText = text;
                ...
                new MaterialDialog.Builder(mContext)
                        ...
                        .build().show();
                UsageAnalytics.sendAnalyticsEvent(Lookup.class.getSimpleName(), "leo");
                return true;
            case DICTIONARY_COLORDICT:
                ...
                UsageAnalytics.sendAnalyticsEvent(Lookup.class.getSimpleName(), "colordict");
                return true;
            case DICTIONARY_FORA:
                ...
                UsageAnalytics.sendAnalyticsEvent(Lookup.class.getSimpleName(), "fora");
                return true;
            case DICTIONARY_NCIKU_WEB:
                ...
                UsageAnalytics.sendAnalyticsEvent(Lookup.class.getSimpleName(), "nciku");
                return true;
            case DICTIONARY_EIJIRO_WEB:
                ...
                UsageAnalytics.sendAnalyticsEvent(Lookup.class.getSimpleName(), "eijiro");
                return true;
        }
        return false;
    }
