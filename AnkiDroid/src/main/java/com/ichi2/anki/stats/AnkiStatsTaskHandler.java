...
public class AnkiStatsTaskHandler {
    ...
    private class CreateChartTask extends AsyncTask<View, Void, PlotSheet>{
        ...
        protected PlotSheet doInBackground(View... params) {
            ...
            try {
                if (!mIsRunning) {
                    AnkiDroidApp.Log(Log.DEBUG, "quiting CreateChartTask(" + mChartType.name() + ") before execution");
                    return null;
                } else
                    AnkiDroidApp.Log(Log.DEBUG, "starting Create ChartTask, type: " + mChartType.name());
    ...
    private static class CreateSmallDueChart extends AsyncTask<View, Void, PlotSheet>{
        ...
        protected PlotSheet doInBackground(View... params) {
            ...
            try {
                if (!mIsRunning) {
                    AnkiDroidApp.Log(Log.DEBUG, "quiting CreateSmallDueChart before execution");
                    return null;
                } else
                    AnkiDroidApp.Log(Log.DEBUG, "starting CreateSmallDueChart");
                mImageView = (ChartView) params[0];
        ...
        protected void onPostExecute(PlotSheet plotSheet) {
            if(plotSheet != null && mIsRunning){
                ...
                mImageView.setVisibility(View.VISIBLE);
                mImageView.invalidate();
                AnkiDroidApp.Log(Log.DEBUG, "finished CreateSmallDueChart");
            }
        }
    ...
    private class CreateStatisticsOverview extends AsyncTask<View, Void, String>{
        ...
        protected String doInBackground(View... params) {
            ...
            try {
                if (!mIsRunning) {
                    AnkiDroidApp.Log(Log.DEBUG, "quiting CreateStatisticsOverview before execution");
                    return null;
                } else
                    AnkiDroidApp.Log(Log.DEBUG, "starting CreateStatisticsOverview" );
        ...
        protected String doInBackground(Object... params) {
            ...
            try {
                ...
                if (!mIsRunning || collection == null || collection.getDb() == null) {
                    AnkiDroidApp.Log(Log.DEBUG, "quiting CreateSmallTodayOverview before execution");
                    return null;
                } else
                    AnkiDroidApp.Log(Log.DEBUG, "starting CreateSmallTodayOverview" );
                ...
                AnkiDroidApp.Log(Log.DEBUG, "CreateSmallTodayOverview query: " + query);
    ...
    private static class CreateFirstStatisticChooserTask extends AsyncTask<Object, Void, Integer>{
        ...
        protected Integer doInBackground(Object... params) {
            ...
            try {
                Collection collection = (Collection) params[0];
                if (!mIsRunning || collection == null || collection.getDb() == null) {
                    AnkiDroidApp.Log(Log.DEBUG, "quiting CreateTodayLearnCountOnly before execution");
                    return null;
                } else
                    AnkiDroidApp.Log(Log.DEBUG, "starting CreateTodayLearnCountOnly" );
