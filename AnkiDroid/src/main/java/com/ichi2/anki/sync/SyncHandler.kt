...
class SyncHandler(
    ...
    val loginForSyncLauncher = activity.registerForActivityResult(
    ...
    val notificationPermissionLauncher = activity.registerForActivityResult(ActivityResultContracts.RequestPermission()) {
    ...
    companion object {
        ...
        private fun isBadgeDisabled() = !AnkiDroidApp.Companion.sharedPrefs().getBoolean("showSyncStatusBadge", true)
    }
}
