...
fun remainingTime(
    ...
    return if (timeSeconds < TIME_HOUR_LONG) {
        ...
        res.getQuantityString(CommonPlurals.reviewer_window_title, timeX, timeX)
        ...
        res.getQuantityString(
            CommonPlurals.reviewer_window_title_hours_new,
            timeX,
            timeX,
            remaining,
        )
        ...
        res.getQuantityString(
            CommonPlurals.reviewer_window_title_days_new,
            timeX,
            timeX,
            remaining,
        )
