...
class BrowserColumnSelectionAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        return when (viewType) {
            BrowserColumnSelectionRecyclerItem.COLUMN_VIEW_TYPE -> {
                val itemView = inflater.inflate(R.layout.browser_column_selection_column, parent, false)
                ColumnViewHolder(itemView)
            }
            BrowserColumnSelectionRecyclerItem.USAGE_VIEW_TYPE -> {
                val itemView = inflater.inflate(R.layout.browser_column_selection_heading, parent, false)
    ...
    fun refreshDataset() {
        // this needs to be done after onMoved, or the drag operation sometimes complete early
        // when on a tablet
    ...
    /**
     * @see R.layout.browser_column_selection_column
     */
    ...
    /** @see [R.layout.browser_column_selection_heading] */
