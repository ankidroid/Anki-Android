...
/**
 * A collections of ids that can be interpreted as being [CardId]s or a [NoteId]s depending on the
 * value of [cardsOrNotes].
 *
...
class BrowserRowCollection(
    ...
    suspend fun queryOneCardIdPerRow(): List<CardId> = when (this.cardsOrNotes) {
        // TODO: This is slower than necessary
