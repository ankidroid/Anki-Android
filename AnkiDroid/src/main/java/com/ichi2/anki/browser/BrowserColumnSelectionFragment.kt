...
class BrowserColumnSelectionFragment : DialogFragment(R.layout.preferences_browser_columns) {
    ...
    private val onCloseDialogCallback =
        object : OnBackPressedCallback(enabled = true) {
            override fun handleOnBackPressed() {
                Timber.d("onCloseDialogCallback")
                dismiss()
            }
        }
    ...
    override fun onDestroy() {
        super.onDestroy()
        onCloseDialogCallback.remove()
        discardChangesCallback.remove()
    }
