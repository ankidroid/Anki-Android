...
class EditNotifications : AnkiActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.title =
            when (mode) {
                Mode.GLOBAL_APP_WIDE -> getString(R.string.app_wide_notifications)
                Mode.GLOBAL_DECK_SPECIFIC -> getString(R.string.deck_specific_notifications)
                Mode.SINGLE_DECK_SPECIFIC -> getString(R.string.edit_notifications)
            }
