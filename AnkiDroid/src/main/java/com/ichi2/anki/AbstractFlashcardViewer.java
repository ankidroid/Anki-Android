...
public abstract class AbstractFlashcardViewer extends NavigationDrawerActivity implements ReviewerUi, CommandProcessor {
    ...
    protected abstract class DismissCard extends NextCardHandler<GetCard, GetBoolean> implements Task<GetCard, GetBoolean> {
        ...
        public DismissCard(Collection.DismissType type, Card card) {
            mType = type;
            mCard = card;
        }
        ...
        public GetBoolean background(CollectionTask<GetCard, ?> collectionTask) {
            ...
            try {
                ...
                try {
                    sched.deferReset();
                    actualBackground(collectionTask);
    ...
    protected void showDeleteNoteDialog() {
        ...
        new MaterialDialog.Builder(this)
                ...
                .onPositive((dialog, which) -> {
                    ...
                    dismiss(new DeleteNote(mCurrentCard, note, mCurrentCard.getId(), note.cards()));
                })
                .build().show();
    }
    ...
    protected class BuryNote extends DismissCard {
        public BuryNote(Card card) {
            super(Collection.DismissType.BURY_NOTE, card);
        }


        protected void actualBackground(CollectionTask<GetCard, ?> collectionTask) {
            Collection col = collectionTask.getCol();
            AbstractSched sched = col.getSched();
            Note note = getCard().note();
            // then bury
    ...
    protected class SuspendNote extends DismissCard {
        ...
        protected void actualBackground(CollectionTask<GetCard, ?> task) {
    ...
    protected class DeleteNote extends DismissCard {
        private final Note mNote;
        private final long mCid;
        private final ArrayList<Card> mAllCs;
        public DeleteNote(Card card, Note mNote, long mCid, ArrayList<Card> mAllCs) {
            super(Collection.DismissType.DELETE_NOTE, card);
            this.mNote = mNote;
            this.mCid = mCid;
            this.mAllCs = mAllCs;
        }
    ...
    protected void dismiss(DismissCard dismiss) {
        blockControls(false);
        dismiss.launch();
    }
