...
public class SdCardReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent.getAction().equals(Intent.ACTION_MEDIA_EJECT)) {
            AnkiDroidApp.Log(Log.INFO, "media eject detected - closing collection and sending broadcast");
            Intent i = new Intent();
            ...
            AnkiDroidApp.Log(Log.INFO, "media mount detected - sending broadcast");
            Intent i = new Intent();
