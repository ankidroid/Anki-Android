...
public class AnkiDroidWidgetSmall extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        AnkiDroidApp.Log(Log.INFO, "SmallWidget: onUpdate");
    ...
    public void onEnabled(Context context) {
        ...
        AnkiDroidApp.Log(Log.INFO, "SmallWidget: Widget enabled");
    ...
    public void onDisabled(Context context) {
        ...
        AnkiDroidApp.Log(Log.INFO, "SmallWidget: Widget disabled");
        SharedPreferences preferences = AnkiDroidApp.getSharedPrefs(context);
    ...
    public static class UpdateService extends Service {
        ...
        public void onStart(Intent intent, int startId) {
            AnkiDroidApp.Log(Log.INFO, "SmallWidget: OnStart");
        ...
        private RemoteViews buildUpdate(Context context, boolean updateDueDecksNow) {
            AnkiDroidApp.Log(Log.INFO, "buildUpdate");
