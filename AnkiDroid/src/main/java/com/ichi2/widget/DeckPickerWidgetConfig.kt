...
class DeckPickerWidgetConfig : FragmentActivity(), DeckSelectionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.done_button).setOnClickListener {
            ...
            val selectedDeckIds = DeckPickerWidgetPreferences.getSelectedDeckIdsFromPreferencesDeckPickerWidgetData(appWidgetId)
    ...
    private fun saveSelectedDecksToPreferencesDeckPickerWidget() {
        ...
        DeckPickerWidgetPreferences.saveSelectedDecksDeckPickerWidgetData(appWidgetId, selectedDecks)
