...
object LanguageUtil {
     ...
     */
    @JvmStatic
    fun getLocale(@SuppressLint("VariableNamingDetector") mLocaleCode: String?, prefs: SharedPreferences): Locale {
        var localeCode = mLocaleCode
        val locale: Locale
        ...
        locale = if (localeCode != null && (localeCode.contains("_") || localeCode.contains("-"))) {
            try {
