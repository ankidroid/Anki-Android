...
class RemoteMediaServer(private val col: Collection?, hkey: String?, con: Connection?, hostNum: HostNum?) : HttpSyncer(hkey, con, hostNum) {
    ...
    private fun <T> _dataOnly(resp: JSONObject, returnType: Class<T>): T {
        ...
        throw RuntimeException("Did not specify a valid type for the 'data' element in resopnse")
    }
