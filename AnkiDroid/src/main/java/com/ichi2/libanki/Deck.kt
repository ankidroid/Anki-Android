...
value class Deck(
    ...
    /**
     * Ensure this deck has a single filter. Either [term] or the current single filter.
     */
    fun ensureSingleFilter(term: Term? = null) {
        val term = term ?: terms[0]
        terms = JSONArray(arrayOf(term))
    }
