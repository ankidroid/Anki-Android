...
public class Stats {
    ...
    public int[] calculateTodayStats(){
        ...
        AnkiDroidApp.Log(Log.DEBUG, "todays statistics query: " + query);
        ...
        AnkiDroidApp.Log(Log.DEBUG, "todays statistics query 2: " + query);
    ...
    public boolean calculateDue(int type) {
        ...
        try {
            ...
            AnkiDroidApp.Log(Log.DEBUG, "Forecast query: " + query);
            cur = mCol
                    .getDb()
                    .getDatabase()
                    .rawQuery(query, null);
    ...
    public boolean calculateDone(int type, boolean reps) {
        ...
        AnkiDroidApp.Log(Log.DEBUG, "ReviewCount query: " + query);
    ...
    public boolean calculateBreakdown(int type) {
        ...
        AnkiDroidApp.Log(Log.DEBUG, sd.get(Calendar.HOUR_OF_DAY) + " : " +cutoff + " breakdown query: " + query);
        try {
            cur = mCol.getDb()
                    .getDatabase()
                    .rawQuery(query, null);
    ...
    public boolean calculateWeeklyBreakdown(int type) {
        ...
        String query = "SELECT strftime('%w',datetime( cast(id/ 1000  -" + sd.get(Calendar.HOUR_OF_DAY)*3600 +
                ...
                "group by wd " +
                "order by wd";
        AnkiDroidApp.Log(Log.DEBUG, sd.get(Calendar.HOUR_OF_DAY) + " : " +cutoff + " weekly breakdown query: " + query);
        try {
            cur = mCol.getDb()
                    .getDatabase()
                    .rawQuery(query, null);
    ...
    public boolean calculateAnswerButtons(int type) {
        ...
        AnkiDroidApp.Log(Log.DEBUG, "AnswerButtons query: " + query);
    ...
    public boolean calculateCardsTypes(int type) {
        ...
        AnkiDroidApp.Log(Log.DEBUG, "CardsTypes query: " + query);
