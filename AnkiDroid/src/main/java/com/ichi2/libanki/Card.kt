...
open class Card : Cloneable {
    ...
    fun timeTaken(): Int {
        ...
        val total = (Time.intTimeMS() - timerStarted).toInt()
     ...
     */
    fun stopTimer() {
        elapsedTime = Time.intTimeMS() - timerStarted
    }
     ...
     */
    fun resumeTimer() {
        timerStarted = Time.intTimeMS() - elapsedTime
    }
