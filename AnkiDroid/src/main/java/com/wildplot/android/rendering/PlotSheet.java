...
//			gFrame.setFont(oldFont.deriveFont(20.0f));
            ...
            int legendCnt = 0;
            AnkiDroidApp.Log(Log.DEBUG, "should draw legend now, number of legend entries: " + mLegendMap.size());
            for(String legendName : keySet){
                ...
                AnkiDroidApp.Log(Log.DEBUG, "drawing a legend Item: (" + legendName + ") " + (legendCnt -1) + ", x: " + (xPointer + rectangleSize) + ", y: " + (ySpacer+rectangleSize));
...
//			gFrame.setFont(oldFont);
	...
	public double ticsCalcY(float pixelDistance, RectangleWrap field){
        ...
        AnkiDroidApp.Log(Log.DEBUG, "PlotSheet ticksCalcY: pixelDistance: " + pixelDistance + ", ticks: " + tics);
		return tics;
	}
