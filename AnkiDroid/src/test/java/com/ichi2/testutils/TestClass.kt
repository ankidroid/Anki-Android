...
interface TestClass {
    ...
    fun addRevNoteUsingBasicNoteTypeDueToday(
        ...
        val note = addNoteUsingBasicNoteType(front, back)
    ...
    fun addNoteUsingBasicAndReversedNoteType(
        front: String = "Front",
        back: String = "Back",
    ): Note = addNoteUsingNoteTypeName("Basic (and reversed card)", front, back)

    fun addNoteUsingBasicTypedNoteType(
        @Suppress("SameParameterValue") front: String,
        @Suppress("SameParameterValue") back: String,
    ...
    fun addNotes(count: Int): List<Note> = (0..count).map { addNoteUsingBasicNoteType() }
