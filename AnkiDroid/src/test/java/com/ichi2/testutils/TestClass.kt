...
interface TestClass {
    ...
    fun addRevBasicNoteDueToday(
        ...
        val note = addBasicNoteType(front, back)
    ...
    fun addNotes(count: Int): List<Note> = (0..count).map { addBasicNoteType() }
