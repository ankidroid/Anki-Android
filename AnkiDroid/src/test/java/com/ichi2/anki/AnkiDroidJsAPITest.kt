...
class AnkiDroidJsAPITest : RobolectricTest() {
    ...
    fun ankiBurySuspendTest() =
        runTest {
            ...
            basic!!.put("did", didA)
            addNoteUsingBasicNoteType("foo", "bar")
            addNoteUsingBasicNoteType("baz", "bak")
            addNoteUsingBasicNoteType("Anki", "Droid")
            addNoteUsingBasicNoteType("Test Card", "Bury and Suspend Card")
            addNoteUsingBasicNoteType("Test Note", "Bury and Suspend Note")
