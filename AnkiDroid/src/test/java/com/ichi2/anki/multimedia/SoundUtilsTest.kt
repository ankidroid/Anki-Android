...
class SoundUtilsTest : RobolectricTest() {
    ...
    fun videoTagSrcIsRelativeNotFileUri() {
        ...
        // a file:// src is blocked by WebView's CORS policy; the src must be a relative
        // path so it is served by ViewerResourceHandler instead
        assertThat(html, not(containsString("file://")))
        assertThat(html, containsString("src=\"my%20video.mov\""))
    }
}
