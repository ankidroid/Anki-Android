...
class BeolingusParserTest {
    ...
    fun testPronunciation() {
        @Language("HTML")
        val html = """<a href="/dings.cgi?speak=de/0/7/52qA5FttGIU;text=Wasser" onclick="return s(this)" onmouseover="return u('Wasser')"><img src="/pics/s1.png" width="16" height="16" alt="[anhören]" title="Wasser" border="0" align="top" /></a>""".trimMargin()
    ...
    fun testHaystackCaseInsensitivity() {
        ...
        @Language("HTML")
        val html = """<a href="/dings.cgi?speak=en/2/0/zQbP7qZh_u2;text=Hello" onclick="return s(this)" onmouseover="return u('Hello')"><img src="/pics/s1.png" width="16" height="16" alt="[listen]" title="Hello" border="0" align="top" /></a>""".trimMargin()
    ...
    fun testEszettCasing() {
        ...
        @Language("HTML")
        val html = """<a href="/dings.cgi?speak=de/8/9/5wbPa4jy41_;text=Straße" onclick="return s(this)" onmouseover="return u('Straße')"><img src="/pics/s1.png" width="16" height="16" alt="[listen]" title="Straße" border="0" align="top" /></a>""".trimMargin()
