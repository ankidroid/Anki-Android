...
class CardBrowserTest : RobolectricTest() {
    ...
    fun tagWithBracketsDisplaysProperly() =
        runTest {
            val n = addBasicNoteType("Hello", "World")
            n.addTag("sketchy::(1)")
            n.flush()
    ...
    fun previewWorksAfterSort() =
        runTest {
            // #7286
            val cid1 = addBasicNoteType("Hello", "World").cards()[0].id
            val cid2 = addBasicNoteType("Hello2", "World2").cards()[0].id
    ...
    fun resetDataTest() =
        runTest {
            TimeManager.reset()
            addBasicNoteType("Hello", "World").firstCard().update {
                due = 5
    ...
    fun checkSearchString() =
        runTest {
            addBasicNoteType("Hello", "John")
            addBasicNoteType("New", "world").firstCard().update {
    ...
    fun checkIfSearchAllDecksWorks() =
        runTest {
            addBasicNoteType("Hello", "World")
            addBasicNoteType("Front", "Back").firstCard().update {
    ...
    private fun getBrowserWithNotes(
        ...
        if (reversed) {
            for (i in 0 until noteCount) {
                addBasicAndReversedNoteType(i.toString(), "back")
            }
        } else {
            for (i in 0 until noteCount) {
                addBasicNoteType(i.toString(), "back")
            }
        }
    ...
    fun `deck id is remembered - issue 15072`() =
        runTest {
            ...
            addBasicNoteType().moveToDeck("First")
            addBasicNoteType().moveToDeck("Second")
