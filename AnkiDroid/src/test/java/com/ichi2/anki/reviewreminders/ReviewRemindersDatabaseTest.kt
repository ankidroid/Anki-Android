...
class ReviewRemindersDatabaseTest : RobolectricTest() {
    ...
    override fun setUp() {
        ...
        // We need a valid activity context for the database since it might run showError
    ...
    override fun tearDown() {
        ...
        AnkiDroidApp.sharedPrefs().edit { clear() }
    }
            ...
            mapOf(
                0 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(9, 0),
                        ReviewReminder.SnoozeAmount.SetAmount(15.minutes, 2),
                        5,
                        did,
                    ),
                1 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(10, 30),
                        ReviewReminder.SnoozeAmount.SetAmount(15.minutes, 2),
                        10,
                        did,
                    ),
    ...
    fun `getAllDeckSpecificReminders should return all reminders across decks`() {
        ...
        val reminders1 =
            mapOf(
                0 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(9, 0),
                        ReviewReminder.SnoozeAmount.Disabled,
                        5,
                        did1,
                    ),
                1 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(11, 0),
                        ReviewReminder.SnoozeAmount.Infinite(15.minutes),
                        5,
                        did1,
                    ),
            )
        val reminders2 =
            mapOf(
                ...
                3 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(12, 30),
                        ReviewReminder.SnoozeAmount.SetAmount(10.minutes, 3),
                        20,
                        did2,
                    ),
            )
        ...
        val newReminders =
            mapOf(
                0 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(9, 0),
                        ReviewReminder.SnoozeAmount.SetAmount(30.minutes, 1),
                        5,
                    ),
                1 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(10, 30),
                        ReviewReminder.SnoozeAmount.SetAmount(60.minutes, 3),
                        10,
                    ),
            )
    ...
    fun `editAllDeckSpecificReminders should update all reminders across decks`() {
        ...
        val reminders1Old =
            mapOf(
                0 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(9, 0),
                        ReviewReminder.SnoozeAmount.SetAmount(15.minutes, 1),
                        5,
                        did1,
                    ),
            )
        ...
        val reminders2New =
            mapOf(
                2 to
                    ReviewReminder.createReviewReminder(
                        ReviewReminder.ReviewReminderTime(10, 45),
                        ReviewReminder.SnoozeAmount.SetAmount(15.minutes, 1),
                        10,
                        did2,
                    ),
