...
import com.ichi2.themes.Themes.APP_THEME_KEY
...
class StudyScreenScreenshotTest(
    ...
    init {
        ...
        Themes.currentTheme = config.theme
        targetContext.sharedPrefs().edit {
            putString(APP_THEME_KEY, config.theme.id)
        }
                            ...
                            for (dev in devices) {
                                val config =
                                    TestConfig(
                                        ...
                                        style,
                                        theme,
                                        dev.copy(nightMode = theme.isNightMode),
                                    )
    ...
    class TestConfig(
        ...
        override fun toString(): String =
            "${qualifier.name}_${theme.name}_toolbar=${toolbarPosition.name}_" +
