...
class PreferencesAnalyticsTest : RobolectricTest() {
    ...
    private val excludedPrefs: Set<String> =
        setOf(
            ...
            R.string.pref_notifications_edit_app_wide_key, // editAppWideNotifications
            R.string.pref_notifications_edit_deck_specific_key, // editDeckSpecificNotifications
