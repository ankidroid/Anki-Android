...
class SettingsSearchBarTest : RobolectricTest() {
    ...
    fun `All indexed XML resIDs lead to the correct fragments on getFragmentFromXmlRes`() {
        ...
        val filesToIndexField = requireAccessibleJavaField(SearchConfiguration::class.java, "filesToIndex")
        val searchItemResIdField = requireAccessibleJavaField(SearchConfiguration.SearchIndexItem::class.java, "resId")
        val preferencesToIndexField = requireAccessibleJavaField(SearchConfiguration::class.java, "preferencesToIndex")
        val prefItemResIdField = requireAccessibleJavaField(PreferenceItem::class.java, "resId")
