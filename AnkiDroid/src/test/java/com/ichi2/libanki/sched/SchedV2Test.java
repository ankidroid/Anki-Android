...
public class SchedV2Test extends RobolectricTest {
     ...
     *****************/
    private final MockClock mTime = new MockClock(2020, 7, 4,11, 22, 19, 0, 10);
    ...
    public void test_learnV2() throws Exception {
        ...
        long dueIn = c.getDue() - col.getClock().intTime();
        ...
        dueIn = c.getDue() - col.getClock().intTime();
    ...
    public void test_filt_keep_lrn_state() throws Exception {
        ...
        assertThat(c.getDue() - col.getClock().intTime(), is(greaterThan(60 * 60L)));
    ...
    public void test_timingV2() throws Exception {
        ...
        c.setDue(col.getClock().intTime() - 1);
        c.flush();
        col.reset();
        c = getCard();
        assertEquals(QUEUE_TYPE_LRN, c.getQueue());
    ...
    public void test_initial_repeat() throws Exception {
        ...
        long expected = col.getClock().intTime() + (int)(5.5 * 60);
        long due = c.getDue();
