...
public class SchedTest extends RobolectricTest {
    ...
    public void test_learnV1() throws Exception {
        ...
        assertEquals(Math.round(c.getDue() - Time.Companion.intTime()), 179, 1);
        ...
        assertEquals(c.getDue() - Time.Companion.intTime(), 599, 1);
    ...
    public void test_reviewsV1() throws Exception {
        ...
        assertThat(c.getDue() - Time.Companion.intTime(), is(greaterThan(118L)));
