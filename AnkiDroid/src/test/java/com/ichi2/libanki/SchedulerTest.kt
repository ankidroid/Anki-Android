...
import com.ichi2.libanki.Consts.CardType.LRN
import com.ichi2.libanki.Consts.CardType.NEW
import com.ichi2.libanki.Consts.CardType.RELEARNING
import com.ichi2.libanki.Consts.CardType.REV
import com.ichi2.libanki.Consts.LEECH_SUSPEND
import com.ichi2.libanki.Consts.QueueType
import com.ichi2.libanki.Consts.QueueType.DAY_LEARN_RELEARN
import com.ichi2.libanki.Consts.QueueType.LRN
import com.ichi2.libanki.Consts.QueueType.MANUALLY_BURIED
import com.ichi2.libanki.Consts.QueueType.NEW
import com.ichi2.libanki.Consts.QueueType.REV
import com.ichi2.libanki.Consts.QueueType.SIBLING_BURIED
...
open class SchedulerTest : JvmTest() {
    ...
    fun test_learn_dayV2() {
        ...
        col.sched.answerCard(c, Ease.GOOD)
        Assert.assertEquals((col.sched.today + 1), c.due)
        Assert.assertEquals(QueueType.DAY_LEARN_RELEARN, c.queue)
        assertNull(col.sched.card)
    ...
    fun test_bury() {
        ...
        c.load()
        Assert.assertEquals(QueueType.MANUALLY_BURIED, c.queue)
        col.sched.buryCards(listOf(c2.id), false)
        c2.load()
        Assert.assertEquals(QueueType.SIBLING_BURIED, c2.queue)
        assertNull(col.sched.card)
