...
class FinderTest : RobolectricTest() {
     ...
     */
    fun isNearCutoff(col: Collection): Boolean {
        val hour = col.time.calendar()[Calendar.HOUR_OF_DAY]
    ...
    fun test_findCards() {
        ...
        */
        ...
        val note_front = note.getItem("Front")
        val note_back = note.getItem("Back")
