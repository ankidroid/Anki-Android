...
tasks.register('assertNonzeroAndroidTests') {
    ...
    def resultsDir = layout.buildDirectory.dir("outputs/androidTest-results/connected/flavors/play")
    doLast {
