...
This page contains information on how you can contribute back to the AnkiDroid project. You do not have to read all of it, just come back when you need an answer to a commonly asked question. You can start by looking at our [good first issuess](https://github.com/ankidroid/Anki-Android/issues?q=is%3Aopen+is%3Aissue+label%3A%22Good+First+Issue%21%22). If you work on an open issue, write down that you are working on it so that nobody else starts doing the same work as you. If you can't work on it anymore, please post another message to let us know. If you want to create your own feature, please post a feature request first so that the core contributors can confirm whether it would be accepted. 
...
If you are maintaining the project, you should set up [dependabot](https://dependabot.com/) on your local repository.

Use `java (gradle/beta)` and submit a PR after testing dependency updates
