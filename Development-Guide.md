...
First you'll need to enable HTML/Javascript debugging, by either running a debug build (for releases older than 2.9alpha52) or by running a new (newer than 2.9alpha52) release and enabling HTML/Javascript debugging in Advanced Preferences.
